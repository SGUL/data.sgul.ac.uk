...
<div class="span9">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseSeven" class="accordion-body collapse">
      <div class="accordion-inner">
        Although we download and elaborate data directly from the authoritative sources, the datasets available on this portal should always be considered non-authoritative sources, at least until the service will be in beta. <br/>
